...
function EditProfileModal(props) {
  ...
  const [firstName, setLastName] = useState("Meeting Room");
    ...
    try {
      ...
      if (inputValidation()) {
        ...
        const updateUserDetails = {
          ...
          email: email,
          address: address,        
          // opening_hrs: dateOfBirth,
          userID: sessionStorage.getItem("username"),
        };

        console.log("User details " + JSON.stringify(updateUserDetails));
                            ...
                            <TimePicker
                              ...
                              onChange={(value) => {
                                if (value == null) {
                                  ...
                                  setdateOfBirth(value.format("HH:mm"));
                                }
                              }}
